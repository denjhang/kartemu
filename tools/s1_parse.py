...
PARSERS[0x1A790496] = _p_texproperty
...
# 挂件/配件模型槽位还可能出现 Toon/BackFace/Mtl/Wire 属性, 复用赛道解析器
for _k in (0x32390645, 0x1A560492, 0x1F9C0505, 0x1F4B04FC, 0x19AA0481, 0x2FFF062B):
    if _k in TRACK_PARSERS:
        PARSERS[_k] = TRACK_PARSERS[_k]
